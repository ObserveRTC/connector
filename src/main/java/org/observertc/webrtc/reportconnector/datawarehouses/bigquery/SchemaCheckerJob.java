...
package org.observertc.webrtc.reportconnector.datawarehouses.bigquery;
...
import org.observertc.webrtc.reportconnector.datawarehouses.bigquery.version01.CreateTables;
...
public class SchemaCheckerJob extends Job {
	...
	@Override
	public void run() {
		org.observertc.webrtc.reportconnector.datawarehouses.bigquery.version01.Config config;
		config = new org.observertc.webrtc.reportconnector.datawarehouses.bigquery.version01.Config(
				this.bigQuery,
				this.projectId,
				this.datasetId,
				this.tableNames,
