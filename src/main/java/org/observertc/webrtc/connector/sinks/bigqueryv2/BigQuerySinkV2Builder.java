...
@Prototype
public class BigQuerySinkV2Builder extends AbstractBuilder implements SinkTypeBuilder {

    private static final Logger logger = LoggerFactory.getLogger(BigQuerySinkV2Builder.class);
    private final Map<ReportType, String> mapping;

    public BigQuerySinkV2Builder() {
    ...
    public Sink build() {
        ...
        BigQuerySinkV2 result = new BigQuerySinkV2(bigQueryService);
        adapters.entrySet()
                .stream()
                .forEach(
                        entry -> {
