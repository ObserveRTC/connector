...
public class ObserverEventEntry implements Entry {
	...
	private static Logger logger = LoggerFactory.getLogger(ObserverEventEntry.class);


	private final Map<String, Object> values;

	public ObserverEventEntry() {
		this.values = new HashMap<>();
	}

	public ObserverEventEntry withServiceUUID(String value) {
	...
	public ObserverEventEntry withServiceName(String value) {
	...
	public ObserverEventEntry withCallName(String value) {
	...
	public ObserverEventEntry withUserId(String value) {
	...
	public ObserverEventEntry withMarker(String value) {
	...
	public ObserverEventEntry withPeerConnectionUUID(String value) {
	...
	public ObserverEventEntry withBrowserId(String value) {
	...
	public ObserverEventEntry withTimestamp(Long value) {
	...
	public ObserverEventEntry withMediaUnitId(String value) {
	...
	public ObserverEventEntry withMediaType(MediaType mediaType) {
		if (mediaType == null) {
			return this;
		}
	...
	public ObserverEventEntry withMediaType(String value) {
		this.values.put(EVENT_TYPE_FIELD_NAME, value);
		return this;
	}

	public ObserverEventEntry withEventType(String value) {
		this.values.put(EVENT_TYPE_FIELD_NAME, value);
		return this;
	}

	public String getEventType() {
		String result = (String) this.values.get(EVENT_TYPE_FIELD_NAME);
		return result;
	}

	public ObserverEventEntry withMessage(String value) {
	...
	public EntryType getEntryType() {
		return EntryType.ObserverEvent;
	}
